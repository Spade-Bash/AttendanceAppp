  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.contentText}>Welcome to your student dashboard</Text>
      </View>

      {/* Bottom Navbar */}
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navButton} onPress={() => {}}>
          <Ionicons name="checkmark-circle-outline" size={28} color="#4b9dea" />
          <Text style={styles.navText}>Check In</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navButton} onPress={() => {}}>
          <Ionicons name="reader-outline" size={28} color="#4b9dea" />
